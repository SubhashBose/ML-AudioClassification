...
1. Required Python libraries are Librosa and Sklearn, and the common set of Python libraries - Pandas, Numpy, Matplotlib. The dependencies can be installed by `pip install -r requirements.txt`
